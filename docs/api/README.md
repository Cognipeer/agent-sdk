...
| expose a large capability catalog without binding every tool up front | [Skills](/api/skills) |
...
| `Skill`, `SkillPolicy`, `DEFAULT_SKILL_POLICY`, `SMALL_TIER_SKILL_POLICY` | Progressive capability disclosure for tool-heavy smart agents. |
...
3. [Skills](/api/skills)
4. [Adapters & Models](/api/adapters)
5. [State & Public Types](/api/types)
