...
export const DEFAULT_PROFILE_CONFIGS: Record<BuiltInRuntimeProfile, ProfileConfig> = {
  fast: {
    ...
    context: {
      ...
      budget: {
        ...
        goalsReserveTokens: 900,
        recentTurnsReserveTokens: 3200,
        toolResponseReserveTokens: 1800,
      },
    },
    planning: {
      mode: "off",
    ...
    delegation: {
      ...
      maxChildCalls: 2,
      maxParallelChild: 1,
      childContextPolicy: "minimal",
      requireJsonOutputContract: true,
    },
    toolResponses: {
      maxToolResponseChars: 2400,
      maxToolResponseTokens: 800,
  ...
  deep: {
    ...
    context: {
      ...
      retrieveArchivedToolResponseOnDemand: true,
      budget: {
        systemReserveTokens: 1400,
        goalsReserveTokens: 1600,
        recentTurnsReserveTokens: 7000,
        toolResponseReserveTokens: 3600,
      },
    },
    planning: {
      mode: "off",
    ...
    toolResponses: {
      maxToolResponseChars: 5400,
      maxToolResponseTokens: 1800,
      defaultPolicy: "keep_structured",
      largeResponsePolicy: "summarize_archive",
      toolResponseRetentionByTool: {},
      criticalTools: [...DEFAULT_CRITICAL_TOOLS],
  ...
  research: {
    ...
    context: {
      ...
      retrieveArchivedToolResponseOnDemand: true,
      budget: {
        systemReserveTokens: 1600,
        goalsReserveTokens: 1800,
        recentTurnsReserveTokens: 9000,
        toolResponseReserveTokens: 4800,
      },
    },
    planning: {
      mode: "off",
    ...
    delegation: {
      ...
      maxChildCalls: 8,
      maxParallelChild: 3,
      childContextPolicy: "full",
      requireJsonOutputContract: true,
    },
    toolResponses: {
      maxToolResponseChars: 7200,
      maxToolResponseTokens: 2200,
      defaultPolicy: "keep_structured",
      largeResponsePolicy: "summarize_archive",
      toolResponseRetentionByTool: {},
      criticalTools: [...DEFAULT_CRITICAL_TOOLS],
